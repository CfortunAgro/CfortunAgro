...
# Casilla para introducir la semana
semana = st.text_input("Introduce la semana (formato sXX):", "s01")

# Crear pestañas para Clima y Mist
tab1, tab2, tab3, tab4, tab5 = st.tabs(["Clima", "Mist R04", "Mist R02", "Mist C02", "Comparar Semanas"])
...
with tab5:
    ...
    if len(semanas_disponibles) < 2:
        ...
        tipo = st.radio("Selecciona el tipo de datos a comparar:", ["Clima", "Mist R04", "Mist R02", "Mist C02"])
